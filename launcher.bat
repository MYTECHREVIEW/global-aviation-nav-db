...
title Global Aviation Nav DB - Control Center
cd /d "%~dp0"
set PORT=3510
...
cls
echo ================================================================
echo     GLOBAL AVIATION NAV DB - LOCAL DEV LAUNCHER
echo ================================================================
echo.
:: Check Port Status
...
powershell -NoProfile -Command "Get-NetTCPConnection -LocalPort 3510 -ErrorAction SilentlyContinue | ForEach-Object { Stop-Process -Id $_.OwningProcess -Force -ErrorAction SilentlyContinue }" >nul 2>&1
timeout /t 1 >nul
goto MENU
