...
const GLOBAL_WAYPOINTS_CATALOG = {
    ...
    // Middle East & Turkey Corridor (OMDB to LTFM)
    'KUTLI': { ident: 'KUTLI', name: 'KUTLI', type: 'WAYPOINT', latitude: 24.864167, longitude: 54.938333, country_code: 'AE' },
    'ATUDO': { ident: 'ATUDO', name: 'ATUDO', type: 'WAYPOINT', latitude: 24.285556, longitude: 54.575556, country_code: 'AE' },
    'GOLGU': { ident: 'GOLGU', name: 'GOLGU', type: 'WAYPOINT', latitude: 23.180833, longitude: 52.519167, country_code: 'AE' },
    'RIBOT': { ident: 'RIBOT', name: 'RIBOT', type: 'WAYPOINT', latitude: 23.037778, longitude: 52.026667, country_code: 'AE' },
    'MIGMA': { ident: 'MIGMA', name: 'MIGMA', type: 'WAYPOINT', latitude: 22.843056, longitude: 51.463611, country_code: 'SA' },
    'SITUK': { ident: 'SITUK', name: 'SITUK', type: 'WAYPOINT', latitude: 23.030000, longitude: 47.811667, country_code: 'SA' },
    'KSA': { ident: 'KSA', name: 'King Khaled VOR (Riyadh)', type: 'VOR-DME', frequency_mhz: '115.00', latitude: 24.886101, longitude: 46.759399, country_code: 'SA' },
    'OVANO': { ident: 'OVANO', name: 'OVANO', type: 'WAYPOINT', latitude: 31.800278, longitude: 39.164167, country_code: 'SA' },
    'SOKAN': { ident: 'SOKAN', name: 'SOKAN', type: 'WAYPOINT', latitude: 33.135833, longitude: 38.368611, country_code: 'JO' },
    'FIRAS': { ident: 'FIRAS', name: 'FIRAS', type: 'WAYPOINT', latitude: 33.871944, longitude: 37.920000, country_code: 'SY' },
    'NISAP': { ident: 'NISAP', name: 'NISAP', type: 'WAYPOINT', latitude: 36.790000, longitude: 36.641667, country_code: 'TR' },
    'BELSU': { ident: 'BELSU', name: 'BELSU', type: 'WAYPOINT', latitude: 39.130833, longitude: 34.286389, country_code: 'TR' },
    'YUCEL': { ident: 'YUCEL', name: 'YUCEL', type: 'WAYPOINT', latitude: 39.578889, longitude: 33.585278, country_code: 'TR' },
    'YAVRU': { ident: 'YAVRU', name: 'YAVRU', type: 'WAYPOINT', latitude: 40.582222, longitude: 31.832778, country_code: 'TR' },
    'ERSEN': { ident: 'ERSEN', name: 'ERSEN', type: 'WAYPOINT', latitude: 40.865556, longitude: 30.666111, country_code: 'TR' },
    // Australia Corridor Waypoints
    'KEPPA': { ident: 'KEPPA', name: 'KEPPA', type: 'WAYPOINT', latitude: -36.796667, longitude: 143.975000, country_code: 'AU' },
    'AVNEX': { ident: 'AVNEX', name: 'AVNEX', type: 'WAYPOINT', latitude: -30.812500, longitude: 115.860556, country_code: 'AU' },
    'ESDEG': { ident: 'ESDEG', name: 'ESDEG', type: 'WAYPOINT', latitude: -29.208889, longitude: 116.023611, country_code: 'AU' },
    'METUM': { ident: 'METUM', name: 'METUM', type: 'WAYPOINT', latitude: -14.136667, longitude: 115.141667, country_code: 'AU' },
    // South China Sea / Southeast Asia Corridors
    'VINIK': { ident: 'VINIK', name: 'VINIK', type: 'WAYPOINT', latitude: 8.641667, longitude: 116.230000, country_code: 'MY' },
    'AKOTA': { ident: 'AKOTA', name: 'AKOTA', type: 'WAYPOINT', latitude: 16.462028, longitude: 117.206750, country_code: 'PH' },
    // Finland & Russia Corridor (EFHK to UUEE)
    'ARVEP': { ident: 'ARVEP', name: 'ARVEP', type: 'WAYPOINT', latitude: 60.249444, longitude: 26.399167, country_code: 'FI' },
