...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        ...
        Title="Global Aviation Nav DB - Dev Launcher" Height="500" Width="520"
    ...
    <Grid Margin="20">
        ...
        <StackPanel Grid.Row="0" Margin="0,0,0,15">
            <TextBlock Text="🌐 Global Aviation Nav DB" FontSize="20" FontWeight="Bold" Foreground="#38BDF8"/>
            <TextBlock Text="Waypoints, Fixes, VORs, NDBs &amp; Route Tracing Engine" FontSize="11" Foreground="#94A3B8" Margin="0,2,0,0"/>
        </StackPanel>
        ...
        <Border Grid.Row="1" Background="#162032" CornerRadius="8" Padding="15" Margin="0,0,0,15" BorderBrush="#1E293B" BorderThickness="1">
            <Grid>
                ...
                <TextBlock Grid.Column="1" Text="Port 3510" FontSize="12" Foreground="#94A3B8" VerticalAlignment="Center"/>
            </Grid>
        </Border>
        ...
        <Grid Grid.Row="2" Margin="0,0,0,15">
            ...
            <Button x:Name="BtnOpenBrowser" Grid.Column="3" Content="🌐 Open UI" Background="#38BDF8" Margin="5,0,0,0"/>
        </Grid>
...
if (-not $scriptDir) { $scriptDir = "Z:\global-aviation-nav-db" }
$port = 3510
...
function Start-ServerProcess {
    ...
    $startInfo.Arguments = "/k cd /d `"$scriptDir`" && title Global Aviation Nav DB Server && node server.js"
...
function Stop-ServerProcess {
    ...
    try {
        ...
        $cmdProcs = Get-CimInstance Win32_Process -Filter "Name = 'cmd.exe'" | Where-Object { $_.CommandLine -like "*Global Aviation Nav DB Server*" }
...
Write-Log "Global Aviation Nav DB Launcher ready."
Update-UIState
